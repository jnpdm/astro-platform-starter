...
- [x] 6.1 Create template data models and storage utilities
...
- [x] 6.2 Write property test for template version increment
  - **Property 27: Template version increment**
  - **Validates: Requirements 8.9**

- [x] 6.3 Create template list page
...
- [x] 6.7 Write property tests for field editing
...
- [x] 6.14 Implement template save with versioning
...
- [x] 6.15 Create template API endpoints
...
- [x] 6.16 Update questionnaire rendering to use templates
  - Load template for questionnaire type
  - Dynamically render form fields based on template
  - Ensure formatting is correct and builds correctly
  - Store templateVersion with submission
  - _Requirements: 8.10_

- [x] 6.17 Write property test for new submissions using current template
  - **Property 28: New submissions use current template**
  - **Validates: Requirements 8.10**

- [x] 6.18 Implement historical submission rendering
...
- [x] 6.19 Write property test for historical template preservation
  - **Property 29: Historical submission template preservation**
  - **Validates: Requirements 8.10, 8.11**

- [x] 6.20 Create template preview page
...
- [x] 6.21 Write property test for preview rendering consistency
  - **Property 30: Preview rendering consistency**
  - **Validates: Requirements 8.12**

- [x] 6.22 Implement removed field handling
...
- [x] 6.23 Write property test for removed field exclusion
  - **Property 31: Removed field exclusion**
  - **Validates: Requirements 8.13**

- [x] 7. Implement partner-centric questionnaire flow
- [x] 7.1 Create gate view pages
...
- [x] 7.2 Write property test for gate view filtering
  - **Property 11: Gate view filtering**
  - **Validates: Requirements 5.1**

- [x] 7.3 Update partner detail page with questionnaire section
...
- [x] 7.4 Write property tests for questionnaire display
  - **Property 12: Questionnaire button text**
  - **Property 14: Partner questionnaire display**
  - **Validates: Requirements 5.2, 5.5**

- [x] 7.5 Implement questionnaire navigation from partner page
...
- [x] 7.6 Write property test for questionnaire navigation
  - **Property 13: Navigation URLs**
  - **Validates: Requirements 5.3**

- [x] 8. Implement reports population
- [x] 8.1 Create report calculation utilities
...
- [x] 8.2 Write property tests for report calculations
  - **Property 4: Gate metrics calculation**
  - **Property 5: Report data completeness**
  - **Validates: Requirements 2.2, 2.4**

- [x] 8.3 Update reports page with data display
...
- [x] 9. Checkpoint - Ensure all Phase 2 tests pass
  - Ensure all tests pass, ask the user if questions arise.

## Phase 3: Advanced Features (Low Priority)

- [x] 10. Implement PDM utilization tracking
- [x] 10.1 Create utilization calculation utilities
...
- [x] 10.2 Write property tests for utilization calculations
...
- [x] 10.3 Add utilization display to PDM dashboard
