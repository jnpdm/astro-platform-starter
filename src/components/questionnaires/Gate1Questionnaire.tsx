/**
 * Gate 1: Ready to Sell Questionnaire Wrapper
 * 
 ...
 * - Validation of gate criteria: project plan approved, GTM strategy approved, 
 *   technical architecture defined, sales team certified
...
interface Gate1QuestionnaireProps {
...
export default function Gate1Questionnaire({
    ...
    /**
     * Check if partner passes Gate 1 criteria
     * All three phases must pass for Gate 1 completion
     */
    const checkGate1Criteria = (statuses: Record<string, SectionStatusType>): {
        passes: boolean;
        reason: string;
        ...
        const reason = allPassed
            ? 'All three phases completed successfully. Partner is Ready to Sell.'
            : `Only ${passedSections} of ${totalSections} phases passed. All phases must pass for Gate 1 completion.`;
    ...
    const handleSignature = async (sig: Signature) => {
        ...
        try {
            ...
            const gate1Assessment = checkGate1Criteria(calculatedStatuses);

            // Determine overall status
            const overallStatus = gate1Assessment.passes ? 'pass' : 'fail';
            ...
            const submissionPayload = {
                ...
                submittedByRole: 'PDM', // Default to PDM for Gate 1
                submittedAt: new Date().toISOString(),
                templateVersion: templateVersion, // Store template version with submission
                metadata: {
                    gate1Assessment: gate1Assessment,
                },
            };
            ...
            <div className="max-w-2xl mx-auto">
                <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center">
                    ...
                    <p className="text-green-700 mb-4">
                        Your Gate 1: Ready to Sell questionnaire has been submitted and saved.
                    </p>
        ...
        return (
            <div className="max-w-4xl mx-auto">
                <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                    ...
                    <div className={`mb-6 p-4 border rounded-md ${gate1Assessment.passes
                        ? 'bg-green-50 border-green-200'
                        : 'bg-red-50 border-red-200'
                        }`}>
                        <p className={`text-sm font-medium mb-2 ${gate1Assessment.passes ? 'text-green-900' : 'text-red-900'
                            }`}>
                            Gate 1: Ready to Sell Assessment
                        </p>
                        <p className={`text-sm ${gate1Assessment.passes ? 'text-green-800' : 'text-red-800'}`}>
                            {gate1Assessment.passes ? '✓' : '✗'} {gate1Assessment.reason}
                        </p>
                        {gate1Assessment.passes && (
                    ...
                    <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-md">
                        ...
                        <p className="text-sm text-blue-800">
                            Passed {gate1Assessment.passedSections} of {gate1Assessment.totalSections} phases.
                            {gate1Assessment.passes
                                ? ' Partner is Ready to Sell and can proceed to Gate 2.'
                                : ' All phases must pass before partner can proceed to Gate 2.'}
                        </p>
                    </div>
